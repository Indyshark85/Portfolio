...
; Step 5: Replace environment structs with define-union envr
;   - Remove (struct empty-env ...) and (struct extend-env ...)
;   - Add (define-union envr (empty) (extend a^ env^))
;   - Change apply-env to use union-case instead of match
;   - Replace all (empty-env) and (extend-env ...) calls with envr_ constructors
...
;============================================================
; Environment — now a define-union (Step 5)
;============================================================
(define-union envr
  (empty)
  (extend a^ env^))
...
;============================================================
; apply-env — now uses union-case on envr (Step 5)
;============================================================
(define (apply-env)
  (union-case *env* envr
              ((empty)
...
;============================================================
; value-of-cps — uses envr_ constructors (Step 5)
;============================================================
(define (value-of-cps)
  (union-case *e* expr
              ((const v)
...
;============================================================
; Top-level helpers — use envr_ constructors (Step 5)
;============================================================
