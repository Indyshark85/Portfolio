...
; Step 3: Registerization
;   - define-registers declares all global registers at the top
;   - Every let* binding in ANF becomes a set! on the corresponding register
;   - All serious functions now take zero arguments
;   - The body after the set!s is the function call (also 0-arg)
...
;============================================================
; Continuation Constructor Helpers — now 0-arg, read/write registers
;============================================================
(define (mult-left-k)
  (k-mult-left *r^* *env^* *k^*))
(define (mult-right-k)
...
(define (throw-k)
  (k-throw *result^* *env^*))
(define (throw-result-k)
  (k-throw-result *k2^*))

;============================================================
; apply-env — 0-arg, reads *env* *y* *k*, writes as needed
;============================================================
(define (apply-env)
  (match *env*
    [(empty-env)
...
;============================================================
; apply-closure — 0-arg, reads *clos* *a* *k*
;============================================================
...
;============================================================
; value-of-cps — 0-arg, reads *e* *env* *k*
;============================================================
(define (value-of-cps)
  (union-case *e* expr
    ((const v)
