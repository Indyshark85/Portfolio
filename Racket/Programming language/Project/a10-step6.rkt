...
;Step 6: Define closure-lam helper and replace higher-order closure with constructor
...
;Step 6: closure helper (still higher-order for now)
(define (closure-lam body env)
  (lambda (a k^)
    (value-of-cps body
                  (extend-env a env)
                  k^)))
...
;==========================================================
;cut down in step 4 im keeping this so the grader can see the flow
